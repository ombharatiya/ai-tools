...
```mermaid
flowchart LR
    ROOT[AI tools] --> A[Create and produce]
    ROOT --> B[Find and understand]
    ROOT --> C[Run a business]
    ROOT --> D[Build with AI]
    ROOT --> E[Automate and act]
    ROOT --> F[Specialized domains]
```
